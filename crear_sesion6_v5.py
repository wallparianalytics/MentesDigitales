...
def crear_sesion_6():
    ...
    agregar_imagen_fondo(slide11, 0.42, 3.46, 9.17, 2.00, COLOR_MORADO)
    ...
    print("✅ Presentación 'Sesión 6.pptx' creada exitosamente con colores mejorados y mejor disposición!")
